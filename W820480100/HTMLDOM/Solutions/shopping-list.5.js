...
function removeFromList(e) {
  ...
  const selector = '#common-items-list>li>button[name="' + 
    item.title + '"]';
...
function addToList(product) {
  ...
  newItem.innerHTML = product + ' '; //space between product and button
  ...
  const selector = '#common-items-list>li>button[name="' + product + '"]';
  const btnMatch = document.querySelector(selector);
  if (btnMatch) {
